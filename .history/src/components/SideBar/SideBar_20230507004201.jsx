...
const StyledForm = styled.form`
  ...
  justify-content: space-around /* margin-top: 1rem; */ @media
    (max-width: 550px) {
          ...
          <StyledSideNav id="main-menu">
            ...
            <StyledFormWrapper>
              ...
              <StyledForm action="">
                ...
                <label htmlFor="">
                  <input className="form-checkbox-field" type="checkbox" />4
                  star and above
                </label>
                <label htmlFor="">
                  <input className="form-checkbox-field" type="checkbox" />3
                  star and above
                </label>
                <label htmlFor="">
                  <input className="form-checkbox-field" type="checkbox" />2
                  star and above
                </label>
                <label htmlFor="">
                  <input className="form-checkbox-field" type="checkbox" />1
                  star and above
                </label>
              </StyledForm>
            </StyledFormWrapper>
