    ...
    <StledMissionWrapper>
      <StyledMission>
        <p>
          ...
          to match and exceed consumer expectations and to provide them with the
          highest value, be it for any situation, such as getting ready for a nighttime stroll or working up a sweat on the pitch.
        </p>
      </StyledMission>
    </StledMissionWrapper>
  )
